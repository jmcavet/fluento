...
const CardContainer = tw.div`shadow-md shadow-neutral-200 dark:shadow-neutral-700 w-full bg-neutral-0 dark:bg-neutral-800 text-neutral-800 dark:text-neutral-100 rounded-3xl text-2xl`;
...
const WordType = tw.div`col-start-4 col-end-7 italic text-2xl font-light text-neutral-500 dark:text-neutral-400`;
...
const VocaContainer = tw.div`flex flex-col gap-4 p-4`;
