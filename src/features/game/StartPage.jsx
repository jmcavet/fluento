...
const MainContainer = tw.div`flex flex-col gap-8 p-8 justify-between h-full bg-neutral-0 dark:bg-neutral-800 text-neutral-900 dark:text-neutral-0 rounded-xl`;
const Container = tw.div`flex flex-col gap-6 p-4 text-neutral-900 dark:text-neutral-0`;
const ContainerTitle = tw.div`flex items-center justify-between gap-4 text-neutral-700 dark:text-neutral-300`;
const LanguageTested = tw.div`flex flex-col items-center justify-center gap-6`;
const FlagButton = tw.button`flex items-center gap-4 border-solid p-[1px] border-white border-[1px]`;
const MethodUsed = tw.div`flex flex-col items-center justify-center gap-6`;
...
const NbWords = tw.span`text-4xl font-semibold mr-2`;
const Score = tw.div`flex flex-col items-center justify-center gap-6`;
const ScoreResult = tw.div`flex items-center justify-between gap-4 p-4 bg-neutral-100 dark:bg-neutral-700 rounded-3xl`;
        ...
        <Container>
          <Score>
            ...
            <ScoreResult>
              ...
              {gamesPlayedSum !== 0 && (
                <div>
                  <span className="text-4xl font-semibold">{scoreToBeat}</span>%
                </div>
              )}
            </ScoreResult>
          </Score>
